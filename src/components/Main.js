        ...
        <div className="row">
          ...
          >
            <div className="content">
              <p>&nbsp;</p>
              <h1>Decentrilized Storage IPFS</h1>
              <p>
                This is a decentralized IPFS/File storage system that connects
                to the blockchain via web3 and requires a crypto payment fee to
                add your Decentralized file to the system{" "}
              </p>
              <div
